...
```bash
gh release view --repo Digiata/Stadium-Builder --json tagName,name,body 2>/dev/null \
  || git ls-remote --tags --refs --sort=-v:refname https://github.com/Digiata/Stadium-Builder.git 'v*' | head -1
```
