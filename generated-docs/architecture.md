...
| Screen routes | `web/src/lib/routes.ts` | `ANIMALS_ROUTE` (`/`), `HABITATS_ROUTE`, `ANIMAL_CREATE_ROUTE` (`/animals/new`), `animalDetailRoute(id)` — the pages a person navigates to. |
